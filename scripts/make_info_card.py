...
ROWS = [
    ...
    ("", ""),
    ("Focus", "Cloud Computing & Data Science educator"),
    ("", "MTech, Data Science and Analytics"),
    ("", ""),
    ("Stack", "Python · AWS · Microsoft Azure · Docker"),
    ("Tools", "Power BI · Tableau · RapidMiner · Kubernetes"),
    ("Also", "DevOps · Cloud Security · Machine Learning"),
    ("", ""),
